...
layui.define(['layer'], function (exports) {
    ...
    var configInfo = localStorage.getItem(setter.tableName);
    if (configInfo === null || typeof (configInfo) === 'undefined' || configInfo === "{}" || configInfo === "") {
    ...
    if (cache) {
        ...
        if (useDefaultTheme) {
            ...
            setter['cacheTab'] = false;
            setter['defaultTheme'] = 'theme-cyan';
            setter['closeFooter'] = true;
            setter['tabAutoRefresh'] = false;
            setter['navArrow'] = '';
        }
    }
