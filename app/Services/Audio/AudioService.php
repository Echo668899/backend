...
//                }),
    ...
    public static function saveMrsData($mrsData, $isPublic = false)
    {
        ...
        if (empty($audioModel)) {
            ...
            AudioModel::update($audioSaveData, array('_id' => $mid));
        }
    ...
    public static function handler($action, $audioId, $money = null)
    {
        switch ($action) {
            case 'click':
                ...
                AudioModel::updateRaw(array('$inc' => array('real_click' => 1)), array('_id' => $audioId));
                ReportAudioLogService::inc($audioId, 'click', 1);
                break;
            case 'buy':
                AudioModel::updateRaw(array('$inc' => array('buy' => 1)), array('_id' => $audioId));
            ...
            case 'favorite':
                ...
                AudioModel::updateRaw(array('$inc' => array('real_favorite' => 1)), array('_id' => $audioId));
            ...
            case 'love':
                ...
                AudioModel::updateRaw(array('$inc' => array('real_love' => 1)), array('_id' => $audioId));
