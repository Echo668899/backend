...
class NovelService extends BaseService
{
    ...
    public static function saveMrsData($mrsData, $isPublic = false)
    {
        ...
        if (empty($novelModel)) {
            ...
            NovelModel::update($novelSaveData, ['_id' => $mid]);
        }
    ...
    public static function handler($action, $novelId, $money = null)
    {
        switch ($action) {
            case 'click':
                ...
                NovelModel::updateRaw(['$inc' => ['real_click' => 1]], ['_id' => $novelId]);
                ReportNovelLogService::inc($novelId, 'click', 1);
                break;
            case 'buy':
                NovelModel::updateRaw(['$inc' => ['buy' => 1]], ['_id' => $novelId]);
            ...
            case 'favorite':
                ...
                NovelModel::updateRaw(['$inc' => ['real_favorite' => 1]], ['_id' => $novelId]);
            ...
            case 'love':
                ...
                NovelModel::updateRaw(['$inc' => ['real_love' => 1]], ['_id' => $novelId]);
