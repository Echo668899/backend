...
class ComicsService extends BaseService
{
    ...
    public static function saveMrsData($mrsData, $isPublic = false)
    {
        ...
        if (empty($comicsModel)) {
            ...
            ComicsModel::update($comicsSaveData, ['_id' => $mid]);
        }
    ...
    public static function handler($action, $comicsId, $money = null)
    {
        switch ($action) {
            case 'click':
                ...
                ComicsModel::updateRaw(['$inc' => ['real_click' => 1]], ['_id' => $comicsId]);
                ReportComicsLogService::inc($comicsId, 'click', 1);
                break;
            case 'buy':
                ComicsModel::updateRaw(['$inc' => ['buy' => 1]], ['_id' => $comicsId]);
            ...
            case 'favorite':
                ...
                ComicsModel::updateRaw(['$inc' => ['real_favorite' => 1]], ['_id' => $comicsId]);
            ...
            case 'love':
                ...
                ComicsModel::updateRaw(['$inc' => ['real_love' => 1]], ['_id' => $comicsId]);
