...
class ReportRepository extends BaseRepository
{
    ...
    public static function getHour($request = [])
    {
        ...
        $items  = ReportHourLogModel::find($query, $fields, [($query['pid'] == 0 ? $sort : 'date_limit') => ($query['pid'] == 0 ? $order : 1)], $skip, $pageSize);
    ...
    public static function getChannel($request = [])
    {
        ...
        $items  = ReportChannelLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at']   = date('y-m-d H:i', $item['created_at']);
            $item['updated_at']   = date('y-m-d H:i', $item['updated_at']);
            $item['reg']          = format_num($item['reg'], 2);
    ...
    public static function getUserChannel($request = [])
    {
        ...
        $items  = ReportUserChannelLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at']   = date('y-m-d H:i', $item['created_at']);
            $item['updated_at']   = date('y-m-d H:i', $item['updated_at']);
            $item['reg']          = format_num($item['reg'], 2);
    ...
    public static function getMovie($request = [])
    {
        ...
        $items  = ReportMovieLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
    ...
    public static function getComics($request = [])
    {
        ...
        $items  = ReportComicsLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
    ...
    public static function getAudio($request = [])
    {
        ...
        $items  = ReportAudioLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
    ...
    public static function getNovel($request = [])
    {
        ...
        $items  = ReportNovelLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
    ...
    public static function getPost($request = [])
    {
        ...
        $items  = ReportPostLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
    ...
    public static function getAdv($request = [])
    {
        ...
        $items  = ReportAdvLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
    ...
    public static function getAdvApp($request = [])
    {
        ...
        $items  = ReportAdvAppLogModel::find($query, $fields, [$sort => $order], $skip, $pageSize);
        foreach ($items as $index => $item) {
            $item['created_at'] = date('Y-m-d H:i', $item['created_at']);
            $item['updated_at'] = date('Y-m-d H:i', $item['updated_at']);
            $item['click']      = format_num($item['click'], 2);
