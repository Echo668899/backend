...
class UserRepository extends BaseRepository
{
     ...
     * @return array
     */
    public static function codeLog($userId, $page = 1, $pageSize = 15)
    {
        return UserCodeLogService::getLog($userId, $page, $pageSize);
    }
    ...
    public static function doVip($userId, $groupId, $paymentId)
    {
        ...
        $orderData = [
            ...
            'pay_name'        => value(function () use ($paymentId) {
                ...
                return $paymentItems[$paymentId]['type'] ?? '';
            }),
            'pay_at'        => 0,
            'pay_rate'      => 0,
            'trade_sn'      => '',
     ...
     * @return array
     */
    public static function getShareLog($userId, $page = 1)
    {
        $ids = UserShareService::getIds($userId, $page);
        foreach ($ids['ids'] as $key => $id) {
            if (empty($id)) {
                unset($ids['ids'][$key]);
            } else {
