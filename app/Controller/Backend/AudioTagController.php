...
use App\Repositories\Backend\Audio\AudioTagRepository;

/**
 * @package App\Controller\Backend
 */
class AudioTagController extends BaseBackendController
{
    /**
     * 初始化
     */
    ...
    {
        if ($this->isPost()) {
            $result = AudioTagRepository::getList($_REQUEST);
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = AudioTagRepository::getDetail($id);
    ...
    {
        $result = AudioTagRepository::save($_POST);
        if ($result) {
    ...
    public function doAction()
    {
        ...
        if ($act == 'del') {
            ...
            foreach ($ids as $id) {
                ...
                AudioTagRepository::update($data);
            }
        }
        $this->sendSuccessResult();
    }
