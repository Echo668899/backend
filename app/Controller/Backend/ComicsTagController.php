...
use App\Repositories\Backend\Comics\ComicsTagRepository;
...
class ComicsTagController extends BaseBackendController
{
    ...
    {
        if ($this->isPost()) {
            $result = ComicsTagRepository::getList($_REQUEST);
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = ComicsTagRepository::getDetail($id);
    ...
    {
        $result = ComicsTagRepository::save($_POST);
        if ($result) {
    ...
    public function doAction()
    {
        ...
        if ($act == 'del') {
            ...
            foreach ($ids as $id) {
                ...
                ComicsTagRepository::update($data);
            }
        }
        $this->sendSuccessResult();
    }
