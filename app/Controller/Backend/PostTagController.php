...
use App\Repositories\Backend\Post\PostTagRepository;

/**
 * @package App\Controller\Backend
 */
class PostTagController extends BaseBackendController
{
    /**
     * 初始化
     */
    ...
    {
        if ($this->isPost()) {
            $result = PostTagRepository::getList($_REQUEST);
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = PostTagRepository::getDetail($id);
    ...
    {
        $result = PostTagRepository::save($_POST);
        if ($result) {
