...
use App\Repositories\Backend\Novel\NovelTagRepository;

/**
 * @package App\Controller\Backend
 */
class NovelTagController extends BaseBackendController
{
    /**
     * 初始化
     */
    ...
    {
        if ($this->isPost()) {
            $result = NovelTagRepository::getList($_REQUEST);
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = NovelTagRepository::getDetail($id);
    ...
    {
        $result = NovelTagRepository::save($_POST);
        if ($result) {
    ...
    public function doAction()
    {
        ...
        if ($act == 'del') {
            ...
            foreach ($ids as $id) {
                ...
                NovelTagRepository::update($data);
            }
        }
        $this->sendSuccessResult();
    }
