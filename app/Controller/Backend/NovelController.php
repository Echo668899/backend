...
use App\Repositories\Backend\Novel\NovelRepository;
...
class NovelController extends BaseBackendController
{
    ...
    {
        if ($this->isPost()) {
            $result = NovelRepository::getList($_REQUEST);
    ...
    public function initData()
    {
        ...
        $this->view->setVar('tagArr', NovelTagService::getGroupAttrAll());
        $this->view->setVar('iconArr', CommonValues::getNovelIcon());
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = NovelRepository::getDetail($id);
            $this->view->setVar('row', $result);
            $this->view->setVar('chapterList', NovelChapterService::getChapterList($id));
        }
        $this->initData();
    }
    ...
    public function chapterDetailAction()
    {
        ...
        $chapter = NovelRepository::getChapterDetail($id);
        if (empty($chapter)) {
            $this->sendErrorResult('章节错误!');
        }
    ...
    {
        $result = NovelRepository::save($_POST);
        if ($result) {
    ...
    public function asyncAction()
    {
        ...
        $result = NovelRepository::asyncMrs($source, $idStr);
        $this->sendSuccessResult($result);
    }
    ...
    public function widgetAction()
    {
        ...
        $this->view->pick("novel/widget/{$type}");
    }
    ...
    {
        if ($this->isPost()) {
            $result = NovelRepository::update($_POST);
            $this->sendSuccessResult($result);
        }
    ...
    {
        if ($this->isPost()) {
            $result = NovelRepository::updateOverlay($_POST);
            $this->sendSuccessResult($result);
        }
        $this->view->setVar('ids', $this->getRequest('ids', 'string'));
        $this->initData();
    ...
    {
        if ($this->isPost()) {
            $result = NovelRepository::updateRemove($_POST);
            $this->sendSuccessResult($result);
        }
        $this->view->setVar('ids', $this->getRequest('ids', 'string'));
        $this->initData();
