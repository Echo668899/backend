...
use App\Repositories\Backend\Movie\MovieTagRepository;
...
class MovieTagController extends BaseBackendController
{
    ...
    {
        if ($this->isPost()) {
            $result = MovieTagRepository::getList($_REQUEST);
    ...
    public function detailAction()
    {
        ...
        if (!empty($id)) {
            $result = MovieTagRepository::getDetail($id);
    ...
    {
        $result = MovieTagRepository::save($_POST);
        if ($result) {
    ...
    public function doAction()
    {
        ...
        if ($act == 'del') {
            ...
            foreach ($ids as $id) {
                ...
                MovieTagRepository::update($data);
            }
        }
        $this->sendSuccessResult();
    }
