...
{
    /** 随机昵称 形容词 */
    public const nickname_tou = ['迷你的', '鲜艳的', '飞快的', '真实的', '骚骚的', '清新的', '幸福的', '可耐的', '快乐的', '冷静的', '醉熏的', '潇洒的', '糊涂的', '积极的', '冷酷的', '深情的', '粗暴的',
        '温柔的', '可爱的', '愉快的', '义气的', '认真的', '骚骚的', '传统的', '潇洒的', '漂亮的', '自然的', '专一的', '听话的', '昏睡的', '狂野的', '等待的', '搞怪的',
        ...
        '眼睛大的', '高贵的', '傲娇的', '心灵美的', '爱撒娇的', '细腻的', '天真的', '怕黑的', '感性的', '飘逸的', '怕孤独的', '忐忑的', '高挑的', '傻傻的', '爱听歌的',
        '还单身的', '孤单的', '寂寞的'];
    /** 名词 */
    public const nickname_wei = ['嚓茶', '皮皮虾', '小奶猫', '哈士奇', '小奶狗', '小狼狗', '沙雕', '皮卡丘', '马里奥', '小霸王', '凉面', '便当', '毛豆', '花生', '可乐', '灯泡', '哈密瓜', '野狼', '背包', '眼神', '缘分', '雪碧', '人生', '牛排',
        '蚂蚁', '飞鸟', '灰狼', '斑马', '汉堡', '悟空', '巨人', '绿茶', '自行车', '保温杯', '大碗', '墨镜', '魔镜', '煎饼', '月饼', '月亮', '星星', '芝麻', '啤酒', '玫瑰',
        '大叔', '小伙', '哈密瓜', '太阳', '树叶', '芹菜', '黄蜂', '蜜粉', '蜜蜂', '信封', '西装', '外套', '裙子', '大象', '猫咪', '母鸡', '路灯', '蓝天', '白云',
        '星月', '彩虹', '微笑', '摩托', '板栗', '高山', '大地', '大树', '砖头', '跳蛋', '鸡翅', '蜻蜓', '红牛', '咖啡', '机器猫', '枕头', '大船', '诺言', '18CM',
        '钢笔', '刺猬', '天空', '飞机', '大炮', '冬天', '洋葱', '春天', '夏天', '秋天', '豌豆', '黑米', '玉米', '眼睛', '老鼠', '白羊', '靓仔', '靓女',
        '季节', '鲜花', '秀发', '大山', '火车', '汽车', '歌曲', '舞蹈', '老师', '导师', '方盒', '大米', '麦片', '水杯', '水壶', '手套', '鞋子', '自行车', '菊花', '奇迹', '身影', '香烟', '夕阳', '台灯', '宝贝', '未来', '皮带', '钥匙', '心锁', '故事', '花瓣', '滑板', '画笔', '画板', '学姐', '店员',
        '饼干', '宝马', '过客', '大白', '时光', '石头', '钻石', '河马', '犀牛', '西牛', '绿草', '抽屉', '柜子', '往事', '寒风', '路人', '橘子', '耳机', '鸵鸟', '朋友',
        ...
        '老虎', '鸭子', '雨', '羽毛', '翅膀', '外套', '火', '丝袜', '钢笔', '冷风', '八宝粥', '烤鸡', '大雁', '音响', '招牌', '胡萝卜', '冰棍', '帽子', '菠萝', '蛋挞', '香水',
        '泥猴桃', '吐司', '溪流', '黄豆', '樱桃', '小鸽子', '小蝴蝶', '爆米花', '花卷', '小鸭子', '小海豚', '小熊猫', '小懒猪', '小懒虫', '荔枝', '镜子', '曲奇', '金针菇',
    ...
    {
        $tou_num  = rand(0, count(self::nickname_tou) - 1);
        $wei_num  = rand(0, count(self::nickname_wei) - 1);
        $nickname = self::nickname_tou[$tou_num] . self::nickname_wei[$wei_num];
        return $nickname;
    }
}
