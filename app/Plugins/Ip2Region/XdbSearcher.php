...
namespace App\Plugins\Ip2Region;
...
class Util
{
    ...
    public static function versionFromHeader($header)
    {
        ...
        if ($header['ipVersion'] == IPv4VersionNo) {
            return IPv4::default();
        } elseif ($header['ipVersion'] == IPv6VersionNo) {
            return IPv6::default();
        }
    ...
    public static function verify($handle)
    {
        ...
        if ($header['version'] == Structure_20) {
            $runtimePtrBytes = 4;
        } elseif ($header['version'] == Structure_30) {
...
class Searcher
{
     ...
     * @param  mixed      $version
     * @param  mixed      $dbFile
     * @param  null|mixed $vectorIndex
     * @param  null|mixed $cBuff
     * @throws Exception
     */
    public function __construct($version, $dbFile, $vectorIndex = null, $cBuff = null)
    {
